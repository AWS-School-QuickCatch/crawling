...
def get_cjmall_products(url):
    ...
    # 모든 cjmall 클래스를 포함하는 타임라인 아이템을 찾습니다.
    items = soup.find_all('div', class_=re.compile(r'timeline-item.*cjmall .*'))
...
products = get_cjmall_products(url)
